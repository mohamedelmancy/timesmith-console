...
export function MultiselectDropdown(options) {
  ...
  var config = {
    search: true,
    height: '15rem',
    placeholder: GetLanguage() === 'en' ? 'Select' : 'اختر',
    txtSelected: GetLanguage() === 'en' ? 'Selected' : 'اختيرت',
    txtAll: GetLanguage() === 'en' ? 'All' : 'الكل',
    txtRemove: GetLanguage() === 'en' ? 'Remove' : 'ازاله',
    txtSearch: GetLanguage() === 'en' ? 'Search' : 'بحث',
    ...options
  };
